...
//
    public void changePass(final int userNumber, final int time){
        if(LocalDate.now().getDayOfMonth()-users[userNumber].getRegistrationDate().getDayOfMonth() >= time){
            users[userNumber].setPassword(utilityPasswordMaker.generatePassword());
        }
    }
